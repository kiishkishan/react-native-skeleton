...
function isPattern(object) {
    return (
        ...
        Object.prototype.isPrototypeOf.call(object, "pattern")
    );
}
...
function findSettings(options) {
    ...
    if (
        ...
        lastOption !== null &&
        !Object.prototype.isPrototypeOf.call(lastOption, "pattern")
    ) {
        return lastOption;
    }
    return null;
...
module.exports = function(context) {
    ...
    return {
        Program: function(node) {
            var leadingComments = excludeShebangs(
            ...
            if (!leadingComments.length) {
                context.report({
                    ...
                    fix: canFix
                        ? genPrependFixer(commentType, node, fixLines, eol)
                        : null
                });
