...
public class FingerprintDialog extends DialogFragment implements FingerprintHandler.Callback {
    ...
    private boolean passCodeAuthenticated = false;
    ...
    public interface DialogResultListener {
        ...
        void onAuthenticated(boolean passCodeAuthenticated);

        void onPasscodeInvoked(String passcodeString);
    ...
    public void onAuthenticated() {
        this.failedTimes = 0;
        this.isAuthInProgress = false;
        this.dialogCallback.onAuthenticated(false);
        dismiss();
    }
    ...
    public void onAuthenticated(boolean passCodeAuthenticated) {
        this.failedTimes = 0;
        this.isAuthInProgress = false;
        this.dialogCallback.onAuthenticated(passCodeAuthenticated);
        dismiss();
    }
    
    @Override
    public void onPasscodeInvoked(String passcodeInvokeCode) {
        this.dialogCallback.onPasscodeInvoked(passcodeInvokeCode);
        dismiss();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            onAuthenticated(this.passCodeAuthenticated);
    ...
    public void promptForKeyguard() {
        this.passCodeAuthenticated = true;
