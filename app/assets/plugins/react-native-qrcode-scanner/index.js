...
export default class QRCodeScanner extends Component {
  ...
  _renderCamera() {
    ...
    console.log('...this.props.cameraProps', this.props.cameraProps);
        ...
        return (
          ...
          >
            <Camera
              ...
              onGoogleVisionBarcodesDetected={this._handleBarCodeRead.bind(
                this
              )}
              type={this.props.cameraType}
              captureAudio={false}
              {...this.props.cameraProps}
              // googleVisionBarcodeType={Camera.Constants.GoogleVisionBarcodeDetection.BarcodeType.CODE_128}
            >
